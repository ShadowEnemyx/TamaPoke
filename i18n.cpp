...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "ENTRENADOR", "EXPLORADOR", "COLECCIONISTA", "INVESTIGADOR", "MAESTRO", "KANTO", "JOHTO", "MAESTRO JOHTO", "COMPLETO",
  ...
  // ---------------- EN ----------------
  {
    ...
    "TRAINER", "SCOUT", "COLLECTOR", "RESEARCHER", "MASTER", "KANTO", "JOHTO", "JOHTO MASTER", "COMPLETE",
  ...
  // ---------------- FR ----------------
  {
    ...
    "DRESSEUR", "ECLAIREUR", "COLLECTIONNEUR", "CHERCHEUR", "MAITRE", "KANTO", "JOHTO", "MAITRE JOHTO", "COMPLET",
  ...
  // ---------------- DE ----------------
  {
    ...
    "TRAINER", "SCOUT", "SAMMLER", "FORSCHER", "MEISTER", "KANTO", "JOHTO", "JOHTO-MEISTER", "KOMPLETT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "ALLENATORE", "ESPLORATORE", "COLLEZIONISTA", "RICERCATORE", "MAESTRO", "KANTO", "JOHTO", "MAESTRO JOHTO", "COMPLETA",
  ...
  // ---------------- PT ----------------
  {
    ...
    "TREINADOR", "EXPLORADOR", "COLECIONADOR", "PESQUISADOR", "MESTRE", "KANTO", "JOHTO", "MESTRE JOHTO", "COMPLETO",
