...
static const DexEntry DEX_TBL[DEX_COUNT + 1] = {
  ...
  { "WOBBUFFET", 0, 0, R_COMUN, 0xD28F, 190, 33, 58, 33, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 202 psychic
...
#define EVOLUTION_RULE_COUNT 122
