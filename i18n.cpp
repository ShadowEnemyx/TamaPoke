...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "Listo para evolucionar!", "3/4 >40 para evolucionar",
    ...
    "Elige tu region", "Elige tu inicial",
    ...
    "TODOS",
    "EFECTIVO", "DEBIL",
    "CAJA", "SIN CAPTURAS", "CAPTURADOS %u/%u",
    "FELIZ!", "VINC +1", "ESPERA",
    "MANANA", "DIA", "TARDE", "NOCHE",
    "META DEX %u", "BONUS DEX", "CONOCIDOS %u/%u",
    "DEX", "TIPO", "CRIADO", "%u/%u",
    "CERCA!",
    ...
    "ENTRENADOR", "EXPLORADOR", "COLECCIONISTA", "INVESTIGADOR", "MAESTRO", "KANTO", "JOHTO", "MAESTRO JOHTO", "COMPLETO JOHTO", "HOENN", "COMPLETO",
  ...
  // ---------------- EN ----------------
  {
    ...
    "Ready to evolve!", "3/4 needs >40 to evolve",
    ...
    "Choose your region", "Choose your starter",
    ...
    "ALL",
    "EFFECTIVE", "WEAK",
    "BOX", "NO CATCHES", "CAUGHT %u/%u",
    "HAPPY!", "BOND +1", "WAIT",
    "MORNING", "DAY", "EVENING", "NIGHT",
    "DEX GOAL %u", "DEX REWARD", "KNOWN %u/%u",
    "DEX", "TYPE", "RAISED", "%u/%u",
    "CLOSE!",
    ...
    "TRAINER", "SCOUT", "COLLECTOR", "RESEARCHER", "MASTER", "KANTO", "JOHTO", "JOHTO MASTER", "JOHTO COMPLETE", "HOENN", "COMPLETE",
  ...
  // ---------------- FR ----------------
  {
    ...
    "Pret a evoluer!", "3/4 >40 pour evoluer",
    ...
    "Choisis ta region", "Choisis ton starter",
    ...
    "TOUS",
    "EFFICACE", "FAIBLE",
    "BOITE", "AUCUNE PRISE", "CAPTURES %u/%u",
    "HEUREUX!", "LIEN +1", "ATTENDS",
    "MATIN", "JOUR", "SOIR", "NUIT",
    "BUT DEX %u", "BONUS DEX", "CONNUS %u/%u",
    "DEX", "TYPE", "ELEVE", "%u/%u",
    "PRESQUE!",
    ...
    "DRESSEUR", "ECLAIREUR", "COLLECTIONNEUR", "CHERCHEUR", "MAITRE", "KANTO", "JOHTO", "MAITRE JOHTO", "COMPLET JOHTO", "HOENN", "COMPLET",
  ...
  // ---------------- DE ----------------
  {
    ...
    "Bereit zur Entwicklung!", "3/4 Werte >40 zur Entwicklung",
    ...
    "Region waehlen", "Starter waehlen",
    ...
    "ALLE",
    "EFFEKTIV", "SCHWACH",
    "BOX", "KEINE FAENGE", "GEFANGEN %u/%u",
    "FROH!", "BND +1", "WARTEN",
    "MORGEN", "TAG", "ABEND", "NACHT",
    "DEX ZIEL %u", "DEX BONUS", "BEKANNT %u/%u",
    "DEX", "TYP", "AUFZ.", "%u/%u",
    "KNAPP!",
    ...
    "TRAINER", "SCOUT", "SAMMLER", "FORSCHER", "MEISTER", "KANTO", "JOHTO", "JOHTO-MEISTER", "JOHTO-KOMPLETT", "HOENN", "KOMPLETT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "Pronto a evolvere!", "3/4 >40 per evolvere",
    ...
    "Scegli la regione", "Scegli l'iniziale",
    ...
    "TUTTI",
    "EFFICACE", "DEBOLE",
    "BOX", "NESSUNA PRESA", "PRESI %u/%u",
    "FELICE!", "LEG +1", "ASPETTA",
    "MATTINA", "GIORNO", "SERA", "NOTTE",
    "OBIETTIVO DEX %u", "BONUS DEX", "VISTI %u/%u",
    "DEX", "TIPO", "ALLEV.", "%u/%u",
    "QUASI!",
    ...
    "ALLENATORE", "ESPLORATORE", "COLLEZIONISTA", "RICERCATORE", "MAESTRO", "KANTO", "JOHTO", "MAESTRO JOHTO", "COMPLETA JOHTO", "HOENN", "COMPLETA",
  ...
  // ---------------- PT ----------------
  {
    ...
    "Pronto a evoluir!", "3/4 >40 para evoluir",
    ...
    "Escolhe a regiao", "Escolhe o inicial",
    ...
    "TODOS",
    "EFETIVO", "FRACO",
    "CAIXA", "SEM CAPTURAS", "APANHADOS %u/%u",
    "FELIZ!", "LACO +1", "ESPERA",
    "MANHA", "DIA", "TARDE", "NOITE",
    "META DEX %u", "BONUS DEX", "CONHECIDOS %u/%u",
    "DEX", "TIPO", "CRIADO", "%u/%u",
    "PERTO!",
    ...
    "TREINADOR", "EXPLORADOR", "COLECIONADOR", "PESQUISADOR", "MESTRE", "KANTO", "JOHTO", "MESTRE JOHTO", "COMPLETO JOHTO", "HOENN", "COMPLETO",
